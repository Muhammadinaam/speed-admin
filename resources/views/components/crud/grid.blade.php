        ...
        <div class="row">
            ...
            <div class="col-md-4 text-{{ $is_rtl ? 'left' : 'right' }}">
                ...
                @if($model->_is_add_enabled)
                    @if(\SpeedAdminPermissions::hasPermission($model->getAddPermissionSlug()))
    ...
    <div class="card-body p-2">
        ...
        <div class="table-responsive">
            ...
            <table
                ...
                data-has_edit_permission="{{\SpeedAdminPermissions::hasPermission($model->getEditPermissionSlug())}}"
                data-has_delete_permission="{{\SpeedAdminPermissions::hasPermission($model->getDeletePermissionSlug())}}"
